...
import { type AudioChunk } from '../content/content.js';
...
export abstract class Live extends Action {
    abstract override run(session: Session, inputs: { audio: Input<AudioChunk>, context?: Input, system?: Input }, outputs: { audio?: Output<AudioChunk>, context?: Output }): Promise<void>;
}
